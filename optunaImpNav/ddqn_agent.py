...
class DQN(nn.Module):
    def __init__(self, in_channels=1, num_actions=6, hidden_dim=128):
        ...
        self.conv2 = nn.Conv2d(84, 42, kernel_size=3, stride=3)
        self.conv3 = nn.Conv2d(42, 21, kernel_size=2, stride=2)
        self.fc4 = nn.Linear(189, 168)
...
class DDQN_Agent:
    def __init__(self, eps_decay, gamma, lr, optim_name, useDepth=False):
        ...
        self.gamma = gamma#gamma is how much future rewards matter. Low gamma is impulsive
        ...
        self.network_update_interval = 5
        ...
        self.optimizer = getattr(optim, optim_name)(self.policy.parameters(), lr=self.learning_rate)
        ...
        for e in range(1, self.max_episodes + 1):
            ...
            while True:
                ...
                if done:
                    ...
                    writer.add_scalar('Average Reward', np.average(rotary_reward_buffer), self.episode)
                    ...
                    break
        writer.close()
        return np.average(rotary_reward_buffer)
