...
dest = DESTS[r.randrange(0, len(DESTS))]
...
class DroneEnv(object):
    ...
    def __init__(self, useDepth=False):
        ...
        self.last_dist = self.get_distance(self.client.getMultirotorState().kinematics_estimated.position) #gets the multirotor state
